-- =========================================================================
-- MIGRATION 076: Add paid_at to customer_packages and update get_pet_package_summary
-- =========================================================================

-- 1. Adicionar coluna paid_at em customer_packages
ALTER TABLE public.customer_packages 
ADD COLUMN IF NOT EXISTS paid_at TIMESTAMPTZ;

-- 1.1 Preencher retroativamente os pacotes já pagos que estejam sem paid_at
UPDATE public.customer_packages 
SET paid_at = purchased_at 
WHERE payment_status = 'paid' AND paid_at IS NULL;

-- 2. Atualizar RPC get_pet_package_summary para retornar paid_at
